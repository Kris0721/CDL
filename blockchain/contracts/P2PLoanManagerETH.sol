...
/**
 * @title P2PLoanManagerETH
 * @dev Peer-to-peer lending contract using native ETH instead of ERC20 tokens
 */
contract P2PLoanManagerETH is ReentrancyGuard {
    ...
    /**
     * @dev Lender funds a loan request with ETH
     */
    ...
    /**
     * @dev Borrower repays loan with ETH
     */
    function repayLoan(uint256 loanId) external payable nonReentrant {
        ...
        require(msg.value <= remainingAmount, "Amount exceeds remaining balance");
        ...
        emit LoanRepaid(loanId, msg.value, loan.totalRepayment - loan.amountRepaid);
